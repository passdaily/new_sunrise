package info.passdaily.new_sun_rise_app.services
...
import info.passdaily.new_sun_rise_app.landingpage.firstpage.viewmodel.ContactUsViewModel
import info.passdaily.new_sun_rise_app.landingpage.firstpage.viewmodel.FaqViewModel
import info.passdaily.new_sun_rise_app.landingpage.firstpage.viewmodel.LoginParentViewModel
import info.passdaily.new_sun_rise_app.landingpage.firstpage.viewmodel.LoginStaffViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.academic_management.AcademicManagementViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.attendance_marking.AttendanceMakingViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.calander.CalendarViewStaffModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.descriptive_exam.DescriptiveExamStaffViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.enquiry.EnquiryViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.exam_center.exam_grade.ExamGradeViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.exam_center.exam_topper.ExamTopperViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.MainActivityParentViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.absent.AbsentViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.annual_report.AnnualReportViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.assignment.AssignmentDetailsViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.assignment.AssignmentViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.calendar.CalendarViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.conveyor.ConveyorViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.description_exam.DExamAreaViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.description_exam.DescriptiveDetailViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.description_exam.DescriptiveExamViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.fees.FeesDetailViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.gallery.image.GalleryViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.home.HomeViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.leave_enquires.LeaveEnquiryViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.library.LibraryViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.map.TrackViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.notification.NotificationViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.objective_exam.OExamAreaViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.objective_exam.ObjectiveDetailViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.objective_exam.ObjectiveExamListViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.online_video.OnlineVideoViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.progress_report.ProgressViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.study_material.StudyInitViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.zoom_layout.JoinLiveInitViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.zoom_layout.LiveScheduledViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.home.StaffHomeViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.inbox.InboxStaffViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.leave.LeaveViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.manage_assignment.AssignmentStaffViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.mark_absent.MarkAbsentViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.exam_center.mark_register.MarkRegisterViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.object_exam.ObjectiveExamStaffViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.online_video.OnlineVideoStaffViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.exam_center.progress_card.ProgressCardViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.exam_center.send_progress_report.SendProgressViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.gallery.GalleryStaffViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.manage_about_faq.ManageAboutFaqViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.manage_album.ManageAlbumViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.info_manage_student.manage_conveyor.ManageConveyorViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.manage_event.ManageEventViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.manage_group.GroupViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.info_manage_student.manage_guardian.GuardianViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.info_manage_student.promote_student.PromoteStudentViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.manage_pta.PtaViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.manage_staff.StaffViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.quick_notification.QuickNotificationViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.info_manage_student.student_info.StudentInfoViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.quick_message.QuickMessageViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.quick_regional_message.QuickRegionalMessageViewModel
...
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.student_remarks.StudentRemarkViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.study_material.StudyMaterialStaffViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.subject_chapter.SubChapterViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.track.TrackStaffViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.update_result.UpdateResultViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.zoomGoLive.ZoomGoLiveViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.zoom_live_class_report.LiveClassReportViewModel
import info.passdaily.new_sun_rise_app.typeofuser.common_staff_admin.zoom_scheduled.ZoomScheduledViewModel
import info.passdaily.new_sun_rise_app.typeofuser.parent.event.ManageEventParentViewModel
