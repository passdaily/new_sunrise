package info.passdaily.new_sun_rise_app.services.client_manager


import info.passdaily.new_sun_rise_app.services.retrofit.ApiInterface
...
//    suspend fun getAllowOnceMore(OexamAttemptId : Int) = apiServices.allowOnceMore(OexamAttemptId)
    ...
    ////PTA List
    suspend fun getPtaListGet(accademicId: Int)
            = apiServices.ptaListGet(accademicId)
